...
void QtGL::AddScene(){
    {
        opengl::CGridPlaneXYPtr obj = opengl::CGridPlaneXY::Create(-150,150,-150,150,0,1);
        obj->setColor(0.8,0.8,0.8);
        obj->setName("gridplane");
        QtGL::theScene.insert( obj );
    }
    {
        opengl::CRenderizablePtr obj = mrpt::opengl::stock_objects::CornerXYZ();
        obj->setName("corner");
        QtGL::theScene.insert( obj);
    }
    {
